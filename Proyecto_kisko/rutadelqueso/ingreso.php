...
<!--formulario de login de participante-->

	<div id="login_form" class="well" style="margin-top:170px; margin-bottom:100px;">
		<form method="POST" action="login.php">
		<input type="text" name="email" class="form-control" required placeholder="Escriba su E-mail">
		<div style="height: 10px;"></div>		
<!--Password: <input type="password" name="password" class="form-control" required> 
		<div style="height: 10px;"></div>-->
		<button type="submit" class="btn btn-primary">Login</button> ¿Deseas participar? <a href="registrate.php"> Regístrate!</a>
		</form>
...
<!--fin formulario de login de participante-->
