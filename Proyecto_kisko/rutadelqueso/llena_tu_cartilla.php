<!DOCTYPE html>
	...
	<head>
		...
		<title>Kiosko - Ingresa y llena tus cartillas - La ruta del queso</title>
										...
										<div class="collapse navbar-collapse" id="navbarNavDropdown">
										  <ul class="navbar-nav">
											<li class="nav-item active">
											  <a style="color: white; " class="nav-link" href="https://www.google.com/?client=safari">C贸mo participar <span class="sr-only">(current)</span></a>
											</li> 
											<li class="nav-item">
...
<!--Inicio Cartilla Virtual-->
<div style="margin-top:170px; margin-bottom:100px;">
...
<?php
	...
	$Id=$_GET['id'];
				...
				$usr=mysqli_query($conn,"select * from usuarios where Id='$Id'");
	           ...
	           echo "<br>";
                ...
                //sacar cartilla activas
                
                $cartillasactivas=mysqli_query($conn,"select *, COUNT(Id) from cartilla where Id_usuario='$Id'");
				$row2=mysqli_fetch_array($cartillasactivas);
                echo "Tienes ".$row2['COUNT(Id)']." cartillas.";
                echo "<br>";

                // Sacar Id de cartilla 
				$cartillas=mysqli_query($conn,"select * from cartilla where Id_usuario='$Id'");
				while($row1=mysqli_fetch_array($cartillas))
				{
                echo "Tu cartilla con id= ".$row1['Id']." ".$row1['Finalizada']." esta finalizada";
  	            echo "<br>";
			    };
...
<footer>
	<nav id="footer1" class="navbar navbar-expand-lg">
