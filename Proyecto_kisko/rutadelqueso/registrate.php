<!DOCTYPE html>
	...
	<head>
		...
		<title>Kiosko - Regístrate - La ruta del queso</title>
...
<div id="signup_form" class="well" style="margin-top:170px; margin-bottom:100px;">
		...
		<div style="height: 10px;"></div>
		<button type="submit" class="btn btn-primary" style="background-color: #d9272e;"><span class="glyphicon glyphicon-save"></span>   Regístrate   </button>
		</form>
		<?php
			session_start();
...
<!--fin formulario de registro de participante-->
